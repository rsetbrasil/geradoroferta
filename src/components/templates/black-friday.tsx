...
<div class="font-body w-full h-full flex flex-col bg-white text-black print:justify-between">
    ...
    <div class="flex items-start justify-center gap-1 my-4 text-black">
        ...
        <span class="font-extrabold leading-none" style="font-size: calc(150px * var(--size-multiplier));">
            {{integerPart}}
        </span>
        <div class="flex flex-col items-start mt-4">
            <span class="font-bold -mb-2" style="font-size: calc(2.5rem * var(--size-multiplier));">,{{decimalPart}}</span>
